...
namespace Ass1.Controllers
{
    public class SalesController : Controller
    {
        ...
        public SalesController(ItemDBContext context, UserManager<Ass1User> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Item,ItemPrice,Buyer,Quantity")] Sales sales)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Item,ItemPrice,Buyer,Quantity")] Sales sales)
        {
            if (id != sales.Id)
            {
                return NotFound();
